...
int main ()
{
    // Vector <int> A(10, 7); // sukuriame 10 elementu turinti A vektoriu ir priskiriame 7 kiekvienai jo reiksmei
    ...
    // B = A;
    // //
    // cout << "Sukurto tuscio vektoriaus B reiksmes prilyginus A vektoriui\n";
